...
df.output <- wildlifeGeese(chr.wrkdir=chr.wildlife.geese.dir,chr.input=chr.input)
## packages
...
chk.sqolim <- 9
chk.Bacteria.Prod <- 8.0000003E+08
### two seasons
chk.Season.1.Months <- c(11,12,1,5,6,7)
chk.Season.2.Months <- c(2,3,4,8,9,10)
### Animal Densities
chk.Season.1.Animal.Density <- 1.3888900E-02
chk.Season.2.Animal.Density <- 1.8518500E-06
### Habitats
chk.Pasture <- 0.0
chk.Forest  <- 0.0
chk.RAOCUT    <- 0.0
...
chk.Percent.Pasture.in.and.around.streams <- 9.3750000E+01
## calculations
## animal numbers
## season 1
