...
### Habitats
chk.Season.1.Pasture <- 134.31
chk.Season.1.Forest  <- 2132.2
chk.Season.1.RAOCUT    <- 1
chk.Season.2.Pasture <- 7.07
chk.Season.2.Forest   <- 157.94
chk.Season.2.RAOCUT   <- 1
### Percent of Landuse with Stream access
chk.Season.1.Percent.Pasture.with.Stream.Access <- 12
chk.Season.1.Percent.Forest.with.Stream.Access  <- 18
chk.Season.1.Percent.RAOCUT.with.Stream.Access   <- 0
chk.Season.2.Percent.Pasture.with.Stream.Access <-  8
chk.Season.2.Percent.Forest.with.Stream.Access  <- 35
