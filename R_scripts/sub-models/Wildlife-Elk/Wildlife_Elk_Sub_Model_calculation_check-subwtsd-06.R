...
### Habitats
chk.Season.1.Pasture <- 143.05
chk.Season.1.Forest  <- 1953.71
chk.Season.1.RAOCUT    <- 1
chk.Season.2.Pasture <- 0
chk.Season.2.Forest   <- 3220.19
chk.Season.2.RAOCUT   <- 1
### Percent of Landuse with Stream access
chk.Season.1.Percent.Pasture.with.Stream.Access <- 17
chk.Season.1.Percent.Forest.with.Stream.Access  <- 25
chk.Season.1.Percent.RAOCUT.with.Stream.Access   <- 0
chk.Season.2.Percent.Pasture.with.Stream.Access <- 13
chk.Season.2.Percent.Forest.with.Stream.Access  <-  3
