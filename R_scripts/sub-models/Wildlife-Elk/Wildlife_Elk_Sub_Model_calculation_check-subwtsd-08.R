...
### Habitats
chk.Season.1.Pasture <- 112.04
chk.Season.1.Forest  <- 2962.9
chk.Season.1.RAOCUT    <- 1
chk.Season.2.Pasture <- 0.78
chk.Season.2.Forest   <- 411.16
chk.Season.2.RAOCUT   <- 1
### Percent of Landuse with Stream access
chk.Season.1.Percent.Pasture.with.Stream.Access <- 18
chk.Season.1.Percent.Forest.with.Stream.Access  <-  7
chk.Season.1.Percent.RAOCUT.with.Stream.Access   <- 0
chk.Season.2.Percent.Pasture.with.Stream.Access <-  7
chk.Season.2.Percent.Forest.with.Stream.Access  <- 34
