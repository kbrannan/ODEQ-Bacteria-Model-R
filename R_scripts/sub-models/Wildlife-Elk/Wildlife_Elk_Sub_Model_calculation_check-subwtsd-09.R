...
### Habitats
chk.Season.1.Pasture <- 49.39
chk.Season.1.Forest  <- 2522.30
chk.Season.1.RAOCUT    <- 1
chk.Season.2.Pasture <- 0
chk.Season.2.Forest   <- 275.9
chk.Season.2.RAOCUT   <- 1
### Percent of Landuse with Stream access
chk.Season.1.Percent.Pasture.with.Stream.Access <- 13
chk.Season.1.Percent.Forest.with.Stream.Access  <- 34
