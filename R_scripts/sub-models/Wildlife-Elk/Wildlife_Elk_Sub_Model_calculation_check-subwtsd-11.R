...
### Habitats
chk.Season.1.Pasture <- 86.3
chk.Season.1.Forest  <- 2946.42
chk.Season.1.RAOCUT    <- 1
chk.Season.2.Pasture <- 0
chk.Season.2.Forest   <- 111.39
chk.Season.2.RAOCUT   <- 1
### Percent of Landuse with Stream access
chk.Season.1.Percent.Pasture.with.Stream.Access <- 11
chk.Season.1.Percent.Forest.with.Stream.Access  <- 46
