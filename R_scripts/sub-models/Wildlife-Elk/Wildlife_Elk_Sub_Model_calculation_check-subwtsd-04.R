...
### Habitats
chk.Season.1.Pasture <- 122.03
chk.Season.1.Forest  <- 1873.39
chk.Season.1.RAOCUT    <- 1
chk.Season.2.Pasture <- 65.27
chk.Season.2.Forest   <- 2542.12
chk.Season.2.RAOCUT   <- 1
### Percent of Landuse with Stream access
chk.Season.1.Percent.Pasture.with.Stream.Access <-  3
chk.Season.1.Percent.Forest.with.Stream.Access  <- 28
chk.Season.1.Percent.RAOCUT.with.Stream.Access   <- 0
chk.Season.2.Percent.Pasture.with.Stream.Access <-  6
chk.Season.2.Percent.Forest.with.Stream.Access  <- 14
