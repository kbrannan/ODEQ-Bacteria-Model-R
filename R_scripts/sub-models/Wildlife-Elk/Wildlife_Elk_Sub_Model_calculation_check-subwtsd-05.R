...
### Habitats
chk.Season.1.Pasture <- 111.66
chk.Season.1.Forest  <- 201.76
chk.Season.1.RAOCUT    <- 1
chk.Season.2.Pasture <- 0
chk.Season.2.Forest   <- 4.19
chk.Season.2.RAOCUT   <- 1
### Percent of Landuse with Stream access
chk.Season.1.Percent.Pasture.with.Stream.Access <- 20
chk.Season.1.Percent.Forest.with.Stream.Access  <- 29
chk.Season.1.Percent.RAOCUT.with.Stream.Access   <- 0
chk.Season.2.Percent.Pasture.with.Stream.Access <-  0
chk.Season.2.Percent.Forest.with.Stream.Access  <- 29
