...
### Habitats
chk.Season.1.Pasture <- 183.94
chk.Season.1.Forest  <- 599.16
chk.Season.1.RAOCUT    <- 1
chk.Season.2.Pasture <- 0
chk.Season.2.Forest   <- 0
chk.Season.2.RAOCUT   <- 1
### Percent of Landuse with Stream access
chk.Season.1.Percent.Pasture.with.Stream.Access <- 23
chk.Season.1.Percent.Forest.with.Stream.Access  <- 44
chk.Season.1.Percent.RAOCUT.with.Stream.Access   <- 0
chk.Season.2.Percent.Pasture.with.Stream.Access <-  0
chk.Season.2.Percent.Forest.with.Stream.Access  <-  0
