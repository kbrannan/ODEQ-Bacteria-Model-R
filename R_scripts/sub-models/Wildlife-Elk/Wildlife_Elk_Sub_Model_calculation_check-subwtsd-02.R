...
### Habitats
chk.Season.1.Pasture <- 278.68
chk.Season.1.Forest  <- 3999.07
chk.Season.1.RAOCUT    <- 1
chk.Season.2.Pasture <- 29.46
chk.Season.2.Forest   <- 1318.61
chk.Season.2.RAOCUT   <- 1
### Percent of Landuse with Stream access
chk.Season.1.Percent.Pasture.with.Stream.Access <- 12
chk.Season.1.Percent.Forest.with.Stream.Access  <- 42
chk.Season.1.Percent.RAOCUT.with.Stream.Access   <- 0
chk.Season.2.Percent.Pasture.with.Stream.Access <-  3
chk.Season.2.Percent.Forest.with.Stream.Access  <- 28
