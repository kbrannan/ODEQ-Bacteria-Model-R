...
### Habitats
chk.habitat <- 5348.10 # where does this number come from it's 545 ac greater than the sum of pasture and forest
### land end pints
chk.land.Forest   <- 4895.63
chk.land.Pasture <- 193.39
chk.land.RAOCUT <- 188.9
