...
### Habitats
chk.habitat <- 6934.9 # where does this number come from it's 545 ac greater than the sum of pasture and forest
### land end pints
chk.land.Forest   <- 6332.94
chk.land.Pasture <- 320.29
chk.land.RAOCUT <- 310.6
