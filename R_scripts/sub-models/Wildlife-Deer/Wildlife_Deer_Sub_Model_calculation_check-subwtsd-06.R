...
### Habitats
chk.habitat <- 5911.40 # where does this number come from it's 545 ac greater than the sum of pasture and forest
### land end pints
chk.land.Forest   <- 5403.36
chk.land.Pasture <- 146.17
chk.land.RAOCUT <- 145.2
