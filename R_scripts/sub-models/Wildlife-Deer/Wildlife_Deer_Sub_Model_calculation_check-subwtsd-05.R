...
### Habitats
chk.habitat <- 368.00 # where does this number come from it's 545 ac greater than the sum of pasture and forest
### land end pints
chk.land.Forest   <- 228.72
chk.land.Pasture <- 114.10
chk.land.RAOCUT <- 114.8
